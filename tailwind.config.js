...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      borderRadius: {
        DEFAULT: "0.125rem", // 2px — `rounded` is intentionally tight
        sm: "0.125rem",      // 2px
        md: "0.25rem",       // 4px — badges, buttons, inputs
        lg: "0.375rem",      // 6px — panels, containers
        xl: "0.5rem",        // 8px — larger containers
        "2xl": "0.75rem",
        full: "9999px",
      },
    },
